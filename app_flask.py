...
@app.route('/predict_param/revenu_median/<revenu_median>/age_median/<age_median>/nb_room_mean/<nb_room_mean>/nb_bedroom_mean/<nb_bedroom_mean>/population/<population>/occupation_mean/<occupation_mean>/latitude/<latitude>/longitude/<longitude>')
def do_prediction_via_param(revenu_median, age_median, nb_room_mean, nb_bedroom_mean, population, occupation_mean, latitude, longitude):
    ...
    return render_template('predict.html', prediction=predict_price)
...
def do_prediction_via_record():
    ...
    # TODO voir comment récupérer les valeurs du formulaire
